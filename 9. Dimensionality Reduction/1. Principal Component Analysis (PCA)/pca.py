# -*- coding: utf-8 -*-
"""
Created on Tue Aug 31 22:02:20 2021
...
'''pca = PCA(n_components = None)   # Correr la primera vez para ver el % de cada componente
'''
pca = PCA(n_components = 2) # Solo usamos los 2 primeros componentes
X_train = pca.fit_transform(X_train)
X_test = pca.transform(X_test)
explained_variance = pca.explained_variance_ratio_  # Explica el % de varianza de cada componente
